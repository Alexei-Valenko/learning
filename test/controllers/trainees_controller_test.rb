...
class TraineesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainee" do
    assert_difference('Trainee.count') do
      post trainees_url, params: { trainee: { name: @trainee.name, trainer_id: @trainee.trainer_id } }
    end
  ...
  test "should update trainee" do
    patch trainee_url(@trainee), params: { trainee: { name: @trainee.name, trainer_id: @trainee.trainer_id } }
